...
Scrape VHR is like SCrape VHD but is looking to extract  Overlays with VHR numbers.
...
class ScrapevhrSpider(CrawlSpider):
    ...
    def __init__(self, index='',  **kwargs):
        ...
        super(ScrapevhrSpider, self).__init__(**kwargs)
        self.logger.info(u'=== INIT ====')
        # self.logger.info(self.start_urls)

    def readVHRindex(self):
